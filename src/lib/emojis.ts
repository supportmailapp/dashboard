...
/** The 'nature' set of emojis from Discord. */
const nature = {
  dog: "🐶",
  cat: "🐱",
  mouse: "🐭",
...
/** The 'food' set of emojis from Discord. */
const food = {
  green_apple: "🍏",
  apple: "🍎",
  pear: "🍐",
...
/** The 'activity' set of emojis from Discord. */
const activity = {
  soccer: "⚽",
  basketball: "🏀",
  football: "🏈",
...
/** The 'travel' set of emojis from Discord. */
const travel = {
  red_car: "🚗",
  taxi: "🚕",
  blue_car: "🚙",
...
/** The 'objects' set of emojis from Discord. */
const objects = {
  watch: "⌚",
  mobile_phone: "📱",
  iphone: "📱",
...
/** The 'symbols' set of emojis from Discord. */
const symbols = {
  heart: "❤️",
  orange_heart: "🧡",
  yellow_heart: "💛",
...
/** The 'flags' set of emojis from Discord. */
const flags = {
  flag_white: "🏳️",
  flag_black: "🏴",
  checkered_flag: "🏁",
...
export { activity, flags, food, nature, objects, people, symbols, travel };

export const allEmojiGroups = [
  [
    people.smile,
    "people",
...
].map(([emoji, name, svg], i) => ({ id: i + 1, emoji, name, svg }));

export function getEmojiGroupByName(name: string) {
  return allEmojiGroups.find((group) => group.name === name) ?? null;
}

export function getEmojiGroupById(id: number): Record<string, string> {
  const cat = allEmojiGroups.find((group) => group.id === id) ?? null;
  if (!cat) return {};
